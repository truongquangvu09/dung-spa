        ...
        <div class="wrapper">
            <div class="border-1">
                <div class="view_content_border-1">
                    <p className="txt_gt_dichvu">CHÀO MỪNG ĐẾN VỚI DUNG SPA</p>
                    <h2 className="txt_gt1">
                ...
                <div class="w_liststieude">
                    <div class="box">
                        ...
                        <div class="w_txtLists">
                            ...
                            <h3>SPA MASTER</h3>
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus sagittis semper
                                tortor.
                            </p>
                        </div>
                    </div>
